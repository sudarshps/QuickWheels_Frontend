...
const Stats:React.FC<StatsProps> = ({totalOrders,totalRevenue}) => {
  return (
   ...
   {/* Total Orders */}
   <div
     className="bg-gradient-to-br from-[#1c1d73] to-[#2a32c8] p-4 rounded-xl"
   >
   ...
   {/* Total Revenue */}
   <div className="bg-gradient-to-br from-[#1c1d73] to-[#2a32c8] p-4 rounded-xl p-4 rounded-xl text-white">
     <div className="flex items-center gap-2">
       <div className="bg-green-500 p-2 rounded-lg text-white"><IndianRupee/></div>
       <div>
